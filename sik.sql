...
INSERT INTO 'lab' ('no_klinik', 'nip' ,'nm_ceklab' ,'hasil_cek' ,'ket' ,'harga' ,'no_laylab')
VALUES ('14101', '12150'. 'Cek Darah', 'positif demam berdarah', 'perlu tindakan lanjut', 50000, '1');

-- Table structure for table 'obat'

CREATE TABLE IF NOT EXISTS 'obat' ( kd_obat varchar(5) NOT NULL, nm_obat varchar(20) NOT NULL, harga double NOT NULL, PRIMARY KEY ('kd_obat')
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table obat

INSERT INTO 'obat' (kd_obat, 'nm_obat, harga') VALUES ('14001', 'Parasetamol', 10000), ('14002', 'Antibiotik', 15000), ('14003', 'Bodrex', 5000);

--Table structure for table pasien

CREATE TABLE IF NOT EXISTS 'pasien' ( 'no_klinik' varchar(5) NOT NULL,'nm_pasien' varchar(25) NOT NULL,
...
INSERT INTO 'pasien' ('no_klinik', 'nm_pasien', 'alm_pasien', 'jk', 'tgl_lahir', 'no_telp', 'umur') 
    VALUES ('14101', 'Dian', 'Yogyakarta', 'Perempuan', '1992-05-13', '098765544443', 21), ('14102', 'Ikhsan', 'Nanggulan', 'Laki-laki', '1990-12-12', '091290430908', 24);
...
INSERT INTO 'pembayaran' ('kd_tnd', 'kd_obat', 'no_klinik', 'tgl_byr', 'tambahan', 'tot_biaya', 'nip', 'no_nota') VALUES ('20000', '20000', '14102', '2015-03-23', 20000, 60000, '14150', '1');
...
INSERT INTO 'pemeriksaan' ('no_rawat', 'no_klinik', 'nip', 'kd_obat', 'diagnosa', 'brt_badan', 'tensi', 'suhu_tubuh', 'ket') VALUES ('1', '14101', '11141', '14002', 'demam berdarah', 45, 120, 35, 'muncul bintik bintik merah'), ('2', '14102', '13150', '14002', 'demam', 60, 110, 37, 'pusing');
...
INSERT INTO 'petugas' ('nip', 'nm_ptg', 'alm_ptg', 'jk', 'tgl_lahir', 'no_telp', 'jabatan', 'no_ijin_praktek', 'pass') 
VALUES ('11141', 'Fitriana', 'Kulon Progo', 'Perempuan', '1990-05-16', '087678098765', 'Admin', '9876544', '123'),
...
INSERT INTO 'registrasi' ('no_reg', 'no_klinik', 'tgl_reg', 'jam_reg') 
    VALUES ('1', '14101', '2015-03-16', '17:00:00'),
            ('2', '14102', '2015-04-12', '11:49:10');

-- Table structure for table tindakan

CREATE TABLE IF NOT EXISTS 'tindakan' ('kd_tnd' varchar(2) NOT NULL, 'nm_tnd' varchar(20) NOT NULL, 'harga' double NOT NULL, PRIMARY KEY ('kd_tnd') 
)ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table 'tindakan'

INSERT INTO 'tindakan' 'kd_tnd', 'nm_tnd', 'harga') 
    VALUES ('01', 'Pemeriksaan', 20000), ('02', 'Cek Urin', 50000), ('03', 'Cek Darah', 50000);
